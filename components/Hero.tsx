      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
        <div className="text-center">
          ...
          <p className="text-lg md:text-xl text-slate-400 mb-12 max-w-4xl mx-auto leading-relaxed">
            We specialize in ultra high-end audio solutions that seamlessly blend into your
            home&apos;s aesthetic. Creating truly immersive experiences with custom-built speakers
            using B&C drivers, Purifi woofers, and Powersoft amplifiers and transducers that
            disappear into the background of your home.
          </p>
